...
$code_sql = [];
$code_sql[0] = "CREATE TABLE IF NOT EXISTS Propriedades (
      numero_de_escritura int not null,
      nome varchar(20) not null,
      tamanho float not null,
      primary key(numero_de_escritura)
    );";
$code_sql[1] = "CREATE TABLE IF NOT EXISTS Localizacao (
...
$code_sql[2] = "CREATE TABLE IF NOT EXISTS Plantacoes (
...
$code_sql[3] = "CREATE TABLE IF NOT EXISTS Cultura (
...
$code_sql[4] = "CREATE TABLE IF NOT EXISTS Atividades(
...
$code_sql[5] = "CREATE TABLE IF NOT EXISTS Colheitas(
...
$code_sql[6] = " CREATE TABLE IF NOT EXISTS Quantidade (
